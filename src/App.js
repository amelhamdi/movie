...
import Ved from './componment/Ved';
import 'bootstrap/dist/css/bootstrap.min.css';
import Navigation from './componment/Navigation';
import Addfilm from './componment/Addfilm';
...
const [text, settext] = useState("");
  ...
  return (
    <div>
     ...
     <Addfilm movies={movies} setmovies={setmovies} text={text}/>
     <Ved/>
     <Movies  
     movies={movies}
        text={text}
